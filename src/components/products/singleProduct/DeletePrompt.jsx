...
function DeletePrompt({ function1, function2, isPending }) {
  return (
    <div className="fixed top-0 left-0 w-full h-full opacity-80 bg-black flex justify-center items-center z-50">
